...
<style>
    ...
    :root { --light-grey: #e0e2f4; --grey: #aaaaaa; --blue: #0414a7; --base-font-size: 20px; --font-stack: 'VT323', monospace; }
    ...
    .container { width: 90%; margin: auto; max-width: 640px; }
    .bsod { padding-top: 10%; }
    .neg { text-align: center; color: var(--blue); }
    .bg { background: var(--grey); padding: 0 15px 2px 13px; }
    .title { margin-bottom: 50px; }
    .nav { margin-top: 35px; text-align: center; }
    .link { text-decoration: none; padding: 0 9px 2px 8px; }
    .link:hover, .link:focus { background: var(--grey); color: var(--blue); }
</style>