<div id="ww-reset-pop-in" class="modal-cont" >
    <div class="modal-content-cont" id="modal-content-cont" >
        ...
        <div class="modal-body" id="modal-body" >
            <form class="modal-form" id="ww-reset-form" method="post" action="/uReset">
                ...
                <div class="butt-box" id="butt-box">
                    <input class="modal-form-button button" id="reset-submit" type="submit" value="Bevestigen" onclick="return uResetBev(event)" >
                </div>
            </form>
        </div>
...
<script>
    ...
    function uResetBev(e) {
        const conf = confirm("Weet u zeker dat uw wachtwoord wilt veranderen ?");
