...
<script>
    ...
    function onScanSuccess(decodedText, decodedResult) { return formatName = decodedResult['result']['format']['formatName'], itemIsbn.value = decodedText, html5QrcodeScanner.clear(), scanForm.submit(); }
    /* onScanError(errorMessage): For now, i simply log the errorMessage, because i dunno how to handle these atm. */
    function onScanError(errorMessage) { return console.log(errorMessage); }
</script>