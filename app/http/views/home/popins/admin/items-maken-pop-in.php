...
<script>
    ...
    const itemNaamInp = document.getElementById('item-naam-inp'), itemIsbnInp = document.getElementById('item-isbn-inp'), itemCoverInp = document.getElementById('item-cover-inp'), itemMakenSubm = document.getElementById('item-maken-submit'), itemSearch = document.getElementById('item-isbn-search-butt');
    itemIsbnInp.addEventListener('input', isbnCheck), itemNaamInp.addEventListener('input', naamCheck), itemCoverInp.addEventListener('change', coverInpCheck), itemMakenSubm.addEventListener('click', saveScroll), itemSearch.addEventListener('click', saveScroll), itemMakenSubm.disabled = true;
